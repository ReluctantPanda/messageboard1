/**
 * @fileoverview Message routes definition for Express router.
 * Defines REST API endpoints for message CRUD operations with middleware integration.
 */
...
/** Express router instance for message-related routes */
const router = express.Router();
/** Controller instance handling message business logic */
const messageController = new MessageController();

/** Configuration object for feature toggles */
const config = {
...
router.delete('/:id',
  rateLimiter,
  idParamValidation,
  config.enableMessageDelete
    ? messageController.deleteMessage.bind(messageController)
    : /** @param req Express request object
        * @param res Express response object
        * @returns JSON response indicating deletion is disabled */
