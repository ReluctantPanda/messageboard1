/**
 * @fileoverview Test suite for message routes API endpoints.
 * Tests CRUD operations for messages using Jest and Supertest.
 * Mocks middleware dependencies to isolate route testing.
 */
